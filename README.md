...
8. You will need a yolov7 pose estimation model (.pt). Here you can download an example: https://github.com/WongKinYiu/yolov7/tree/pose (Remember change the file's name in est_dist.py for his correct usage)
